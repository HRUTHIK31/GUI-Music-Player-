...
os.chdir (directory) 
#os, 1istdir() returns a list containing the name of the entries in the directory given by path. songlist = os.listdir() 
...
var = tkr. StringVar () 
songtitle = tkr. Label (musieplayer, font="Helvetica 12 bold”, text variable=var) songtitle. pack() 
Button1. pack (fill="x” ) 
Button2.pack (fill="x") 
Button3.pack(fill="x") 
Button4.pack(fill="x") 
